    ...
    <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="guru.php">Home</a></li>
                    ...
                    <form action="" method="post">
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-5 col-md-5 col-12">
                                <input type="text" name="nama_guru" id="nama_guru" autofocus class="form-control"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <input type="text" name="nip_guru" id="nip_guru" class="form-control"
                        ...
                        <div class="mt-5 row">
                            ...
                            <div>
                                <a href="guru.php" class="btn btn-warning m-3">kembali</a>
                            </div>
